...
const CartDetail = () => {
  ...
  const [itemQuantities, setItemQuantities] = useState(
    cartDetails.items.reduce((acc: any, item: any) => {
  ...
  return (
    <div>
      <div className="min-h-screen bg-white pt-20">
        ...
        <div className="flex items-center pl-20 pb-5 mt-4 text-center">
          <ChevronLeftIcon className="h-5 w-5 mr-2 text-black font-bold" />
                      ...
                      <div className="mt-4 flex justify-between sm:space-y-6 sm:mt-0 sm:block sm:space-x-6">
                        ...
                        <div className="flex items-center space-x-4">
                          ...
                          <svg
                            ...
                            onClick={() =>
                              dispatch(
                                productAction.removeItemFromCart(item.id)
                              )
                            }
                          >
                            <path
          ...
          <div className="sticky top-10 mb-6 mt-6 h-full rounded-lg border bg-white p-6 shadow-md md:mt-0 md:w-full md:max-w-xs lg:max-w-md">
            ...
            {isCheckingOut ? (
              ...
              <button
                ...
                className="mt-6 w-full bg-slate-900 py-3 font-medium text-white hover:bg-gray-700"
              >
                Checkout
              </button>
            )}
